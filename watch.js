...
function runUpdate() {
  ...
  exec('node convert.js', { cwd: ROOT }, (err, stdout, stderr) => {
    ...
    const pushCmd = [
      'git add data/outbound/aging-dom.json data/outbound/aging-imp.json data/outbound/car.json data/warehouse/pallet.json data/poi/in.json data/poi/uot.json data/meta.json index.html',
